...
class ForecastDetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent != null && intent.hasExtra(EXTRA_FORECAST_PERIOD)) {
            ...
            val setUnits = sharedPrefs.getString(getString(R.string.pref_units_key), "Fahrenheit")
            var unitString: String = when (setUnits) {
                getString(R.string.pref_units_value_fahrenheit) -> {
                    "F"
                }
                getString(R.string.pref_units_value_celsius) -> {
                    "C"
                }
                else -> {
                    "K"
            ...
            findViewById<TextView>(R.id.tv_low_temp).text =
                getString(R.string.forecast_temp, forecastPeriod!!.lowTemp, unitString)

            findViewById<TextView>(R.id.tv_high_temp).text =
                getString(R.string.forecast_temp, forecastPeriod!!.highTemp, unitString)
